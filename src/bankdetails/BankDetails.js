    ...
    <React.Fragment>
      ...
      <FormControl className={ classes.formControl }>
        <FormInput
          name='taxId'
          value={ taxId }
          description={<Translate text='Tax ID'/>}
          onChange={ props.onChange }
        />
      </FormControl>
    </React.Fragment>
    ...
    <React.Fragment>
      ...
      <FormControl className={ classes.formControl }>
        <FormDropdown
          ...
          items={[
            { key: 'CHECKING', value: 'Checking account' },
            { key: 'CURRENT', value: 'Current account' },
            { key: 'SAVINGS', value: 'Savings account' }
          ]}
        />
      </FormControl>
...
export function PeruRecipient(props) {
  ...
  const bankCode = props.bankCode ? props.bankCode : ''
  const accountType = props.accountType ? props.accountType : ''
  const idDocumentType = props.idDocumentType ? props.idDocumentType : ''
  const idDocumentNumber = props.idDocumentNumber ? props.idDocumentNumber : ''
