...
function CanadianRecipient (props){
  ...
  return(
      <div>
          <FormInput name="institutionNumber" value={institutionNumber} description="Institution number" onChange={props.onChange}  />
          <FormInput name="transitNumber" value={transitNumber} description="Transit number" onChange={props.onChange}  />
          <FormInput name="accountNumber" value={accountNumber} description={<Translate text="Account number"/>} onChange={props.onChange}  />
          <FormDropdown name="accountType" value={accountType} description="Account type" onChange={props.onChange} items={[{'key': 'CHECKING', 'value': 'Checking account'}, {'key': 'SAVINGS', 'value': 'Savings account'}]} />
      </div>
  );
}
...
function SingaporeanRecipient (props){
  ...
  return(
      <div>
          <FormInput name="accountNumber" value={accountNumber} description={<Translate text="Account number"/>} onChange={props.onChange}  />
          <FormDropdown name="bankCode" value={bankCode} description={<Translate text="Bank code"/>} onChange={props.onChange} items={bankCodes} />
      </div>
  );
}
...
function VietnamEarthportRecipient (props){
  ...
  return(
      <div>
          <FormInput name="accountNumber" value={accountNumber} description={<Translate text="Account number"/>} onChange={props.onChange}  />
          <FormDropdown name="bankCode" value={bankCode} description={<Translate text="Bank code"/>} onChange={props.onChange} items={bankCodes} />
          <FormInput name="branchCode" value={branchCode} description={<Translate text="Branch code"/>}  />
